...
// Add items to the array which correspond to the prizes in the segments of the wheel.
...
// In order to work correctly the the start and end angles need to match the beginning and end of the segments for the prizes in your wheel image.
// Thinking about a clock face, 0 is at the 12 o'clock, 90 is at the 3 o'clock, 180 is 6 o'clock, 270 is 9 o'clock.
var prizes = new Array();
prizes[0] = {"name" : "Golden Ticket", "startAngle" : 0,   "endAngle" : 14};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "Raffle Ticket", "startAngle" : 15,  "endAngle" : 44};
prizes[2] = {"name" : "Treasure Chest", "startAngle" : 45,  "endAngle" : 74};
prizes[3] = {"name" : "Raffle Ticket", "startAngle" : 75, "endAngle" : 104};
prizes[4] = {"name" : "2 Hrs Early", "startAngle" : 105, "endAngle" : 134};
prizes[5] = {"name" : "Raffle Ticket", "startAngle" : 135, "endAngle" : 164};
prizes[6] = {"name" : "Alt Work Sched", "startAngle" : 165, "endAngle" : 194};
prizes[7] = {"name" : "2 Hrs Early", "startAngle" : 195, "endAngle" : 224};
prizes[8] = {"name" : "Treasure Chest", "startAngle" : 225, "endAngle" : 254};
prizes[9] = {"name" : "Raffle Ticket", "startAngle" : 255, "endAngle" : 284};
prizes[10] = {"name" : "Free Spin", "startAngle" : 285, "endAngle" : 314};
prizes[11] = {"name" : "2 Hrs Early", "startAngle" : 315, "endAngle" : 344};
prizes[12] = {"name" : "Golden Ticket", "startAngle" : 345, "endAngle" : 359};
		...
		if ((doPrizeDetection) && (prizes))
		{
			...
			for (x = 0; x < (prizes.length); x ++)
			{
				if ((relativeAngle >= prizes[x]['startAngle']) && (relativeAngle <= prizes[x]['endAngle']))
				{
					...
					document.getElementById('output').innerHTML = ("You won " + prizes[x]['name'] + "!\nClick 'Reset' to have another go.");
					break;
				}
			}
		}
